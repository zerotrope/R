...
On a broader note, the reader may be interested in visualizing the survival regarding other parameters such as the sex parameter...
...
...and especially the treatment parameter...
...
... with the aim to introduce the reader to the observation of the difference in treatment variable to be explicited in the later to come log-rank test.
...
Returning a p-value even worse than for the log-rank test preventing us from rejecting the null hypothesis one again. 
