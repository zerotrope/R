...
We observe six covariates being significant to the data that we decide to select in order to refine our analysis.
...
Please note that mentionning the as.factor() function on the edema parameter heped fix the plot of the baseline.
