...
Our MAPE result returns a bad score. Let's implement a different fitting model in order to try increasing our prediction score.

## Fitting a logistic regression model to our trian set
